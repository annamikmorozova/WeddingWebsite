  ...
  return (
    <div className="App">
      <header className="header-container">
        ...
        <div className="navbar-style">Erik + Anna</div>
         <div className="navbar-style">Venue</div>
          <div className="navbar-style">Registry</div>
          <div className="navbar-style">Submit a song</div>
          <div className="navbar-style">RSVP</div>
        </div>
      </header>
